...
<head>
    ...
    <title>Dashboard Courier - TRENDZ</title>
        ...
        <div class="flex flex-1 w-full h-full overflow-hidden">
            ...
            <aside id="sidebar"
                ...
                <nav class="mt-8 space-y-3 sidebar-links text-[15px]">
                    <a href="{{ route('courier.dashboard') }}" class="flex items-center gap-2 hover:text-[#5979f5]">
                        <i class="fas fa-chart-line"></i><span>Dashboard</span>
                    </a>
                    <a href="{{ route('courier.products.index') }}" class="flex items-center gap-2 hover:text-[#5979f5]">
                        <i class="fas fa-box"></i><span>Dikirim</span>
                    </a>
                    <a href="{{ route('courier.categories.index') }}"
                        class="flex items-center gap-2 hover:text-[#5979f5]">
                        <i class="fas fa-tags"></i><span>Terkirim</span>
                    </a>
                    </a>
